...
**THE BOARD SPELLS THIS ONE "Stamp My Plans", IN THREE WORDS.** The brand is
StampMyPlans, one word, and it stays that way as a brand. Where this site
states the REGISTRATION, it uses the Board's spelling, because that is the
string the Board is prepared to confirm. The two are different facts and
normalising either into the other would make one of them a claim its source
does not support.

That closes the reason this section used to give for the gate being shut: the
registration was in a name this site did not hold out under. **The board now
holds this site's name as a DBA on the registration.**
