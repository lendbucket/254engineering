...
// ===========================================================================
{
   ...
   */
  const migration = readSource("supabase/migrations/0007_order_tiers.sql");
  rec(
...
// ===========================================================================
{
  const src = readSource("data/catalog.ts");
  /*
...
// ===========================================================================
{
   ...
   */
  const flowSource = readSource("src/components/order/OrderFlow.tsx");
  rec(
...
// ===========================================================================
{
  ...
  const route = readSource("src/app/api/portal/orders/reconcile/route.ts");
  rec(
  ...
  const hook = readSource("src/app/api/stripe/webhook/route.ts");
  ...
  const pay = readSource("src/lib/ops-payments.ts");
...
// ===========================================================================
{
  ...
  const route = readSource("src/app/api/portal/orders/refund/route.ts");
  ...
  const dash = readSource("src/lib/ops-dashboard.ts");
...
// ===========================================================================
{
  ...
  const bulk = readSource("src/lib/ops-bulk.ts");
  rec(
...
// ===========================================================================
{
  const st = readSource("src/lib/ops-statements.ts");
  /*
  ...
  // The operator side.
  const admin = readSource("src/lib/ops-accounts-admin.ts");
  rec(
  ...
  const route = readSource("src/app/api/portal/accounts/route.ts");
