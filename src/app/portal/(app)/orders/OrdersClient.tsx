    ...
    try {
      ...
      setNote(
        data.refundedCents > 0
          ? `Canceled and refunded ${money(data.refundedCents)}.`
        ...
        {orders.map((o) => {
          ...
          return (
            <li key={o.id} className="py-4">
              ...
              <p className="mt-1.5 max-w-[76ch] text-[13.5px] leading-[1.6] text-[var(--secondary)]">
                {o.attention.detail}
              </p>

              {found ? (
                <p
                  className={`mt-2 max-w-[76ch] rounded-[3px] px-3 py-2 text-[13.5px] leading-[1.6] ${
                    found.verdict === "paid_unrecorded"
                      ? "bg-[var(--warn-bg)] text-[var(--warn-ink)]"
                      : "bg-[var(--canvas)] text-[var(--secondary)]"
                  }`}
                >
              ...
              {canRefund ? (
                refunding === o.id ? (
                  <div className="mt-3 max-w-[76ch] rounded-[4px] border border-[var(--border)] bg-white p-3">
                    <label
                      htmlFor={`reason-${o.id}`}
                      className="block portal-kicker text-[var(--navy)]"
                    >
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="mt-2 w-full rounded-[3px] border border-[var(--border)] px-2.5 py-2 text-[13.5px] text-[var(--navy)]"
                    />
                    <div className="mt-2 flex flex-wrap items-center gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex min-h-[44px] items-center px-2 text-[13.5px] font-semibold text-[var(--secondary)] underline"
                      >
                        Leave it
                      </button>
