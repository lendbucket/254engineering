 ...
 * AND THE CUTOVER IS DEFERRED AGAIN, 2026-09-10, SO RULING 6 IS OPERATIVE.
  ...
  {
    file: "0056_the_engineer_states_the_discipline.sql",
    fingerprint: "56b351a693ec70cc86203fd0cbde481c",
    behaviour: "72b8ec3ab4975f1178add4a64261d88a",
    proves: {
      table: "eng_protocol_templates",
    ...
    because:
      "PENDING. It goes to production at a morning sitting with the operator, before Aman approves. " +
      "Operator ruling, 2026-09-21, the same rule 0055 was held under: a migration touching the " +
      "engineer's own protocol does not land while nobody is watching. " +
